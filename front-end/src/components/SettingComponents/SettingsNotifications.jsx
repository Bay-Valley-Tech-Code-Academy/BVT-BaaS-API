...
export default function SettingsNotifications() {
    return(
        <div id="user-storage" className="flex flex-col bg-white rounded-2xl w-96 p-4">
                <h1 className="font-bold text-2xl mb-8">Notifications</h1>

                <div className="flex flex-col justify-between w-full h-96 mb-8">
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        after:transition-all dark:border-gray-600 peer-checked:bg-dashboard-purple-300
                        "></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Rating reminders notifications</span>
                    </label>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        after:transition-all dark:border-gray-600 peer-checked:bg-dashboard-purple-300
                        "></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Meetups near you notifications</span>
                    </label>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        after:transition-all dark:border-gray-600 peer-checked:bg-dashboard-purple-300
                        "></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Company news notifications</span>
                    </label>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        after:transition-all dark:border-gray-600 peer-checked:bg-dashboard-purple-300
                        "></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">New launches and projects</span>
                    </label>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        after:transition-all dark:border-gray-600 peer-checked:bg-dashboard-purple-300
                        "></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Monthly product changes</span>
                    </label>
                    ...
                    <label className="inline-flex items-center cursor-pointer">
                        ...
                        after:transition-all dark:border-gray-600 peer-checked:bg-dashboard-purple-300
                        "></div>
                        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Subscribe to newsletter</span>
                    </label>
